                                        ...
                                        <form method="post" action="{{url('/create/teacher')}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-group">
                                                    <input value="{{old('dob')}}"name="dob"  type="date" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy" data-provide="datepicker" data-date-autoclose="true">
