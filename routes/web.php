...
Route::get('/edit/{id}', [AdminController::class,'teacheredit'])->name('admin.teacheredit');
Route::post('/edit/{id}', [AdminController::class,'teacher_update'])->name('admin.teacher_update');
...
Route::get('/oparetor_edit/{id}', [AdminController::class,'oparetoredit'])->name('admin.oparetoredit');
Route::post('/oparetor_edit/{id}', [AdminController::class,'oparetor_update'])->name('admin.oparetor_update');
Route::get('/oparetor/delete/{id}', [AdminController::class,'Oparetordestroy'])->name('admin.Oparetordestroy');
Route::get('/oparetor/suspend/{id}', [AdminController::class,'Oparetorsuspend'])->name('admin.Teachersuspend');
Route::get('/oparetor/active/{id}', [AdminController::class,'Oparetoractive'])->name('admin.Teacheractive');
	//----------------------oparetor route end---------------------------------------------//
...
Route::get('/student_edit/{id}', [AdminController::class,'studentedit'])->name('admin.studentedit');
Route::post('/student_edit/{id}', [AdminController::class,'student_update'])->name('admin.student_update');
...
Route::get('/Admin/subjectlist', [AdminController::class,'sublist'])->name('admin.sublist');
Route::get('/subject_edit/{id}', [AdminController::class,'subject_edit'])->name('admin.subject_edit');
Route::post('/subject_edit/{id}', [AdminController::class,'subject_update'])->name('admin.subject_update');
Route::get('/subject/delete/{id}', [AdminController::class,'Subjectdestroy'])->name('admin.Subjectdestroy');
	//----------------------subject route end---------------------------------------------//

	//----------------------section route start---------------------------------------------//
//-------------add section rout------------------------//
Route::get('/create/section', [AdminController::class,'create_section'])->name('create_section');
Route::post('/create/section', [AdminController::class,'Addsection'])->name('Addsection');
